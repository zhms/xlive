...
export interface MessageLogInterface {
     ...
     *
     * @param options
     * @param options.msg 待查询的消息
     * @param options.done 回调，第二个回调参数是消息列表
     */
    subMessages(options: {
        msg: NIMMessage;
        done?: (err: NIMCommonError | Error | NIMStrAnyObj | null, messageArr: NIMMessage[]) => void;
    }): void;
    /**
     ...
     * @param options
     * @param options.msg 待查询的消息
     * @param options.done 回调，第二个回调参数是所有回复消息数量
     */
    subMessagesCount(options: {
        msg: NIMMessage;
        done?: (err: NIMCommonError | Error | NIMStrAnyObj | null, count: number) => void;
    }): void;
}
