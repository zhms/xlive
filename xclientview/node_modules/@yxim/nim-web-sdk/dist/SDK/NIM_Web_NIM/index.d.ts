...
export default class NIM extends EventEmitter<NIMSignalingEventInterface> implements CloudSessionInterface, CloudStorageInterface, EventInterface, FriendInterface, MessageExtendInterface, MessageInterface, MessageLogInterface, MiscInterface, NIMInterface, PassThroughInterface, PluginInterface, SessionInterface, SignalingInterface, SuperTeamInterface, SystemMessageInterface, TeamInterface, UserInterface, UtilsInterface {
    ...
    addSuperTeamMembersFollow(options: {
        teamId: string;
        accountIds: string[];
        done: (err: NIMCommonError | Error | NIMStrAnyObj | null, teamMember?: Partial<NIMSuperTeamMember> | undefined) => void;
    }): void;
    removeSuperTeamMembersFollow(options: {
        teamId: string;
        accountIds: string[];
        done: (err: NIMCommonError | Error | NIMStrAnyObj | null, teamMember?: Partial<NIMSuperTeamMember> | undefined) => void;
    }): void;
    addTeamMembersFollow(options: {
        teamId: string;
        accountIds: string[];
        done: (err: NIMCommonError | Error | NIMStrAnyObj | null, teamMember?: Partial<NIMTeamMember> | undefined) => void;
    }): void;
    removeTeamMembersFollow(options: {
        teamId: string;
        accountIds: string[];
        done: (err: NIMCommonError | Error | NIMStrAnyObj | null, teamMember?: Partial<NIMTeamMember> | undefined) => void;
    }): void;
    getMySuperTeamMembers(options: {
        teamIds: string[];
        done: (err: NIMCommonError | Error | NIMStrAnyObj | null, data: NIMSuperTeamMember[]) => void;
    }): void;
    getMyTeamMembers(options: {
        teamIds: string[];
        done: (err: NIMCommonError | Error | NIMStrAnyObj | null, data: NIMSuperTeamMember[]) => void;
    }): void;
    getUsersFromDB(options: {
        accountIds?: string[] | undefined;
        done?: ((err: NIMCommonError | Error | NIMStrAnyObj | null, data: NIMUserNameCard[]) => void) | undefined;
    }): void;
    ...
    getFriendsFromDB(options: {
        accountIds?: string[] | undefined;
        done?: ((err: NIMCommonError | Error | NIMStrAnyObj | null, data: NIMFriendProfile[]) => void) | undefined;
    }): void;
    /**
     * <ul>
    ...
    subMessages(options: {
        msg: NIMMessage;
        done?: ((err: NIMCommonError | Error | NIMStrAnyObj | null, messageArr: NIMMessage[]) => void) | undefined;
    }): void;
    subMessagesCount(options: {
        msg: NIMMessage;
        done?: ((err: NIMCommonError | Error | NIMStrAnyObj | null, count: number) => void) | undefined;
    }): void;
